...
const StoryCard = ({ profileImage, userName, story }) => {
  ...
  return (
    <div className='flex flex-col w-20'>
      ...
      <div className={`w-20 h-20 ${!story?null:!viewed? "bg-linear-to-b from-blue-500 to-blue-950" : "bg-linear-to-r from-gray-500 to-black-950"}  rounded-full flex justify-center items-center relative`} onClick={handleClick}>
      ...
      <div className='text-3.5 text-center truncate w-full text-white'>{userName}</div>
