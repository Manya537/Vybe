  ...
  return (
    <div className='w-full min-h-screen bg-black flex items-center flex-col gap-5'>
        <div  className='w-full h-20 flex items-center gap-5 px-5'>
            <IoIosArrowRoundBack className='text-white cursor-pointer w-6.25 h-6.25' onClick={()=>navigate(`/profile/${userData?.userName}`)}/>
        ...
        <input type="text" className='w-[90%] max-w-150 h-15 bg-[#0a1010] border-2 border-gray-700 rounded-2xl text-white font-semibold px-5 outline-none' placeholder='Enter Your Name'
        onChange={(e)=>setName(e.target.value)} value={name} />
         ...
         <input type="text" className='w-[90%] max-w-150 h-15 bg-[#0a1010] border-2 border-gray-700 rounded-2xl text-white font-semibold px-5 outline-none' placeholder='Bio' onChange={(e)=>setBio(e.target.value)} value={bio}/>
          ...
          <input type="text" className='w-[90%] max-w-150 h-15 bg-[#0a1010] border-2 border-gray-700 rounded-2xl text-white font-semibold px-5 outline-none' placeholder='Profession'
          onChange={(e)=>setProfession(e.target.value)} value={profession}/>

           <input type="text" className='w-[90%] max-w-150 h-15 bg-[#0a1010] border-2 border-gray-700 rounded-2xl text-white font-semibold px-5 outline-none' placeholder="Gender" onChange={(e)=> setGender(e.target.value)}
           value={gender} />
